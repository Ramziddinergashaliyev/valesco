...
//                 <span className="blog-page__card-category">
//                     {article.category || 'Статья'}
//                 </span>
//                 {article.read_time && (
//                     <span className="blog-page__card-readtime">{article.read_time}</span>
//                 )}
//             </div>
...
//     const handleCardClick = (slug) => navigate(`/blog/${slug}`);
...
//                     Экспертные статьи о моторных маслах, вязкости и технических характеристиках.
//                     Всё, что нужно знать для правильного выбора.
//                 </p>
//             </section>
...
//                 {!loading && error && (
//                     <div className="blog-page__empty" role="alert">{error}</div>
//                 )}
...
//                                 <ArticleCard key={article.id} article={article} featured onClick={handleCardClick} />
//                             ))}
//                         </div>
