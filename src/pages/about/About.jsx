        ...
        <div className="about__take">
          ...
          <div className="about__take-info">
            ...
            <div className="about-info">
              <p className="about-info-title">Для развития глобального бизнеса смазочных материалов Valesco и базового масла YUBASE в 2009 году была создана дочерняя компания SK Lubricants, ответственная за развитие направления, в том числе на территории России и стран СНГ, где масла Valesco продаются с 1998 года.</p>
