...
//                 <button onClick={() => setFilterHide(p => !p)} className='product-filter-left'><img src={filter} alt="filterImg" />Скрыть фильтр</button>
//                 <div className="product-filter-right">
//                     <button onClick={() => setHide(false)} className='product-filter-right-info'>
//                         <img src={img2} alt="product-col-img" />
//                     </button>
//                     <button onClick={() => setHide(true)} className='product-filter-right-info'>
...
//                             <div className="product-filter-result-left">
...
//                                         <div key={el?.id} className="product-box-left">
